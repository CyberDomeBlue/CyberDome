...
createadminaccount()
def whitelist():
    whitelisturlin = ("netsh advfirewall firewall name=WhiteListGoogle remoteip=172.217.3.228 protocol=tcp port=443 dir=in action=allow")
    subprocess.call(whitelisturl, shell=True)
    print("[*]Google Has now been whitelisted")
    time.sleep(1)
    whitelisturlout = ("netsh advfirewall firewall name=WhiteListGoogle remoteip=172.217.3.228 protocol=tcp port=443 dir=out action=allow")
    subprocess.call(whitelisturlout, shell=True)
    print("[*]Google Has now been whitelisted")
whitelist()
